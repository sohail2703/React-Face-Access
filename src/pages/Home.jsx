    ...
    <div className="bg-white py-40 md:pt-60 md:pb-24">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-24">
          ...
          The Facial Recognition-Based Authentication Application is an advanced web application built with React and powered by face-api.js. Its primary goal is to provide a robust and effective authentication system by analyzing and verifying users' facial features.
          </p>
          <Link
            to={"/user-select"}
